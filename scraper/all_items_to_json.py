...
with open("scraper/all_items.html", encoding="utf-8") as f:
...
with open("all_items.json", "w", encoding="utf-8") as f:
    json.dump(items_raw, f, ensure_ascii=False, indent=2)

print(f"Done. Wrote {len(items_raw)} items to all_items.json")
